<template>
  <div class="box">
    <div class="header">
      ...
      <el-button type="primary" class="fa" @click="sky">发布</el-button>
    </div>
    <div>
      <el-form
        :model="ruleForm"
      ...
      >
        ...
        <div class="form">
          ...
          <el-form-item label="请选择时间">
            <el-date-picker
              v-model="Property or method "date" is not defined on the instance but referenced during render. Make sure that this property is reactive, either in the data option, or for class-based components, by initializing the property.date"
              type="datetime"
              placeholder="选择日期时间"
              align="right"
    ...
    <div class="bu">
      <button class="btn" @click="sky">发布</button>
    </div>
  </div>
</template>
