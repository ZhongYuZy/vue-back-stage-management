<template>
  <div id='app'>
    <el-table :data="tableData" border style="width: 100%">
      <el-table-column prop="date" label="#" width="50"  align="center"> </el-table-column>
      <el-table-column prop="title" label="标题" width="400"  align="center"> </el-table-column>
      <el-table-column prop="author" label="作者"  align="center" width="130"> </el-table-column>
      ...
      <el-table-column prop="star" label="重要性" width="250"  align="center"> </el-table-column>
      <el-table-column prop="date" label="发布时间" width="200"  align="center"> </el-table-column>
      <el-table-column prop="作" label="操作" width="300"  align="center"> </el-table-column>
    </el-table>
  </div>
</template>
