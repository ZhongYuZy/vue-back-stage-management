<template>
  <div class="box">
    <div class="header">
      <el-button type="primary" class="cha" @click='onclick'>发布</el-button>
      <el-button  type="danger" class="fa">返回</el-button>
    </div>
    <div>
      <el-form
        :model="ruleForm"
...
export default {
  ...
  methods: {
      onclick(){
          axios.post('/apiart/icle/article' , {
          }).then((res) => {
              console.log(res);
              this.
          }).catch((err) => {
  ...
  mounted() {
    //   this.getData()
    this.id2=this.$route.query.id1
    this.ruleForm=this.id2
