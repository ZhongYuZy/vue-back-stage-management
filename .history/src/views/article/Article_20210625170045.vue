      ...
      >
        ...
        <div class="form">
          ...
          <el-form-item label="类目" prop="region">
           ...
           <el-form-item label="类 prop="region">
            <el-select v-model="ruleForm.region" placeholder="请选择活动区域">
              <el-option label="原创" value="sichaun"></el-option>
              <el-option label="转载" value="chengdu"></el-option>
              <el-option label="与他人合作" value="chengdu1"></el-option>
            </el-select>
          </el-form-item>
        </div>
      </el-form>
